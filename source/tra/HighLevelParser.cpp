...
int HighLevelParser::GetIntID(LowLevelParser::container_type::iterator element)
{
    char* errptr;
...
void HighLevelParser::AggregateEntry(int EntryID, vector<LowLevelParser::container_type::iterator>& stack)
{
    switch (stack.size()) {
    case 2: //I T > I
...
void HighLevelParser::LoadFromFile(const char* Filename)
{
    m_entries.clear();
...
void HighLevelParser::SaveToFile(const char* Filename) const
{
    ofstream out;
